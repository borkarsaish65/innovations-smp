...
project_template_dir = './entityTemplates'  # Update this path if the files are in a different directory
...
if not project_files:
    ...
    for project_file in project_files:
        command = [
            ...
            "entityService.py",
            "--env", "dev",
            "--EntityFile", os.path.join(project_template_dir, project_file)
        ]
