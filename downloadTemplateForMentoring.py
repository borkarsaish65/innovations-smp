...
folder_url = os.getenv("GOOGLE_DRIVE_FOLDER_URL_FOR_MENTORING")
if not folder_url:
    raise ValueError("GOOGLE_DRIVE_FOLDER_URL_FOR_MENTORING is not set in the .env file.")
