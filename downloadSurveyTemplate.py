...
folder_url = os.getenv("GOOGLE_DRIVE_FOLDER_URL_FOR_SURVEY")
if not folder_url:
    raise ValueError("GOOGLE_DRIVE_FOLDER_URL_FOR_SURVEY is not set in the .env file.")
...
output_dir = "programTemplates_survey_service"
