...
folder_url = os.getenv("GOOGLE_DRIVE_FOLDER_URL_FOR_USER_SERVICE")
if not folder_url:
    raise ValueError("GOOGLE_DRIVE_FOLDER_URL_FOR_USER_SERVICE is not set in the .env file.")
...
output_dir = "userservicetemplate"
